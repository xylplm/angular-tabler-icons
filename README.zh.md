...
[![tabler-icons-version](https://img.shields.io/badge/Tabler%20Icons-v3.41.0-%23206bc4?style=flat-square)](https://tabler.io/icons)
...
此版本包含 **Tabler Icons v3.41.0**。有关完整的更改列表，请参阅 [更新日志](https://tabler.io/icons/changelog)。
